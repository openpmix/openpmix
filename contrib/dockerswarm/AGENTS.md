...
| `run-mca-tests.sh` | The `src/mca/base` unit suite plus malformed MCA parameters, in the `--enable-mca-dso` configuration where the component repository is actually exercised (README §14) |
