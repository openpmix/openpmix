    ...
    AC_ARG_ENABLE([mca-no-build],
        [AS_HELP_STRING([--enable-mca-no-build=LIST],
                        [Comma-separated list of <type>-<component> pairs
                         that will not be built.  Example: "--enable-mca-no-build=plog,pcompress-zlib" will disable building all plog components and the "zlib" pcompress component.])])
    AC_ARG_ENABLE(mca-dso,
        AS_HELP_STRING([--enable-mca-dso=LIST],
                       [Comma-separated list of types and/or
                        ...
                        platform.]),
                        [], [enable_mca_dso=pcompress,pnet-sshot])
