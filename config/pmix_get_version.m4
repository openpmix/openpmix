...
dnl
dnl This file is also used as input to pmix_get_version.sh.
dnl
...
m4_define([PMIX_GET_VERSION],[
	...
	[eval] "$pmix_vers"
        ...
        if test $$2_WANT_REPO_REV -eq 1 && test $pmix_ver_need_repo_rev -eq 1 ; then
