...
# PMIX_SETUP_COMPONENT_PACKAGE(1: framework_name,
#                              2: component_name,
#                              3: option_name,
...
# - Run PMIX_CHECK_PACKAGE (check for the specific presence of header
...
# Enjoy.
#
AC_DEFUN([PMIX_SETUP_COMPONENT_PACKAGE],[
    AC_ARG_WITH([$3],
