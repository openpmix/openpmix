 ...
 * $HEADER$
 *
 * This file is included at the top of src/include/pmix_config.h, and is
 * therefore a) before all the #define's that were output from
 * configure, and b) included in most/all files in PMIx.
 *
 * Since this file is *only* ever included by src/include/pmix_config.h, and
 * src/include/pmix_config.h already has #ifndef/#endif protection, there is no
...
/* The only purpose of this file is to undef the PACKAGE_<foo> macros
   ...
   Note that we can't put them directly in src/include/pmix_config.h (e.g., via
