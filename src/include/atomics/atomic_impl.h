...
#define pmix_atomic_swap_ptr(addr, value) pmix_atomic_swap_32((int32_t *) addr, value)
#elif SIZEOF_VOID_P == 8 && PMIX_HAVE_ATOMIC_SWAP_64
#define pmix_atomic_swap_ptr(addr, value) pmix_atomic_swap_64((int64_t *) addr, value)
#endif
