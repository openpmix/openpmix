 ...
 *  - \c PMIX_HAVE_ATOMIC_MATH_64 if 32 bit add/sub/cmpset can be done "atomicly"
 *
...
#ifndef PMIX_ATOMIC_H
#define PMIX_ATOMIC_H 1
 ...
 *
 *********************************************************************/
#if PMIX_ASSEMBLY_ARCH == PMIX_ALPHA
#include "atomics/alpha/atomic.h"
#elif PMIX_ASSEMBLY_ARCH == PMIX_AMD64
#include "atomics/amd64/atomic.h"
#elif PMIX_ASSEMBLY_ARCH == PMIX_ARM
#include "atomics/arm/atomic.h"
#elif PMIX_ASSEMBLY_ARCH == PMIX_IA32
#include "atomics/ia32/atomic.h"
#elif PMIX_ASSEMBLY_ARCH == PMIX_IA64
#include "atomics/ia64/atomic.h"
#elif PMIX_ASSEMBLY_ARCH == PMIX_MIPS
#include "atomics/mips/atomic.h"
#elif PMIX_ASSEMBLY_ARCH == PMIX_POWERPC32
#include "atomics/powerpc/atomic.h"
#elif PMIX_ASSEMBLY_ARCH == PMIX_POWERPC64
#include "atomics/powerpc/atomic.h"
#elif PMIX_ASSEMBLY_ARCH == PMIX_SPARC
#include "atomics/sparc/atomic.h"
#elif PMIX_ASSEMBLY_ARCH == PMIX_SPARCV9_32
#include "atomics/sparcv9/atomic.h"
#elif PMIX_ASSEMBLY_ARCH == PMIX_SPARCV9_64
#include "atomics/sparcv9/atomic.h"
#elif PMIX_ASSEMBLY_ARCH == PMIX_SYNC_BUILTIN
#include "atomics/sync_builtin/atomic.h"
#elif PMIX_ASSEMBLY_ARCH == PMIX_OSX_BUILTIN
#include "atomics/osx/atomic.h"
#endif
...
/**********************************************************************
 *
 * Memory Barriers - defined here if have barriers
 *                   but can't inline
 *
 *********************************************************************/
#if !defined(PMIX_HAVE_ATOMIC_MEM_BARRIER)
/* no way to emulate in C code */
#define PMIX_HAVE_ATOMIC_MEM_BARRIER 0
#endif

#if PMIX_HAVE_ATOMIC_MEM_BARRIER
/**
 * Memory barrier
 *
...
#endif /* PMIX_HAVE_ATOMIC_MEM_BARRIER */
...
#if !defined(PMIX_HAVE_ATOMIC_SPINLOCKS)
...
#if PMIX_HAVE_ATOMIC_SPINLOCKS || (PMIX_HAVE_ATOMIC_CMPSET_32 || PMIX_HAVE_ATOMIC_CMPSET_64)
 ...
 *
 *********************************************************************/
#if !defined(PMIX_HAVE_ATOMIC_CMPSET_32)
#define PMIX_HAVE_ATOMIC_CMPSET_32 0
#endif
...
#if !defined(PMIX_HAVE_ATOMIC_CMPSET_64)
#define PMIX_HAVE_ATOMIC_CMPSET_64 0
#endif
...
#if !defined(PMIX_HAVE_ATOMIC_MATH_32)
  /* define to 0 for these tests.  WIll fix up later. */
  #define PMIX_HAVE_ATOMIC_MATH_32 0
#endif

#if PMIX_HAVE_ATOMIC_MATH_32 || PMIX_HAVE_ATOMIC_CMPSET_32
...
#if PMIX_HAVE_ATOMIC_MATH_64 || PMIX_HAVE_ATOMIC_CMPSET_64
