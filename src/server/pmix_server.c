...
pmix_status_t PMIx_Get(const pmix_proc_t *proc,
                       const char key[], pmix_value_t **val)
{
    pmix_shift_caddy_t *cd;
    pmix_status_t rc;
