 ...
 * \endcode
 */
PMIX_EXPORT int pmix_cmd_line_create(pmix_cmd_line_t *cmd, pmix_cmd_line_init_t *table);
 ...
 */
PMIX_EXPORT int pmix_cmd_line_add(pmix_cmd_line_t *cmd, pmix_cmd_line_init_t *table);
 ...
 *
 */
PMIX_EXPORT int pmix_cmd_line_make_opt_mca(pmix_cmd_line_t *cmd, pmix_cmd_line_init_t entry);
 ...
 *
 */
PMIX_EXPORT int pmix_cmd_line_make_opt3(pmix_cmd_line_t *cmd, char short_name, const char *sd_name,
 ...
 */
PMIX_EXPORT int pmix_cmd_line_parse(pmix_cmd_line_t *cmd, bool ignore_unknown,
 ...
 */
PMIX_EXPORT char *pmix_cmd_line_get_usage_msg(pmix_cmd_line_t *cmd)
 ...
 */
PMIX_EXPORT bool pmix_cmd_line_is_taken(pmix_cmd_line_t *cmd, const char *opt)
 ...
 */
PMIX_EXPORT char *pmix_cmd_line_get_argv(pmix_cmd_line_t *cmd, int index);
 ...
 */
PMIX_EXPORT int pmix_cmd_line_get_ninsts(pmix_cmd_line_t *cmd, const char *opt)
    __pmix_attribute_nonnull__(1) __pmix_attribute_nonnull__(2);
 ...
 * caller.
 */
PMIX_EXPORT char *pmix_cmd_line_get_param(pmix_cmd_line_t *cmd, const char *opt, int instance_num,
                                          int param_num);
 ...
 */
PMIX_EXPORT int pmix_cmd_line_get_tail(pmix_cmd_line_t *cmd, int *tailc, char ***tailv);
