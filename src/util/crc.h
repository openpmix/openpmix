...
#define PMIX_CSUM_PARTIAL(SRC, LEN, UI1, UI2) pmix_uicsum_partial(SRC, LEN, UI1, UI2)
...
static inline unsigned long pmix_bcopy_csum(const void *source, void *destination, size_t copylen,
                                            size_t csumlen)
{
...
static inline unsigned int pmix_bcopy_uicsum(const void *source, void *destination, size_t copylen,
                                             size_t csumlen)
{
    unsigned int pint = 0;
    size_t plength = 0;
...
static inline unsigned long pmix_csum(const void *source, size_t csumlen)
{
 ...
 */
static inline uint16_t pmix_csum16(const void *source, size_t csumlen)
{
...
static inline unsigned int pmix_uicsum(const void *source, size_t csumlen)
{
...
static inline unsigned int pmix_bcopy_uicrc(const void *source, void *destination, size_t copylen,
                                            size_t crclen)
{
...
static inline unsigned int pmix_uicrc(const void *source, size_t crclen)
{
