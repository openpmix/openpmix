...
__pmix_attribute_always_inline__ static __inline__ type pmix_thread_ ## name ## _fetch_ ## suffix (pmix_atomic_ ## type *addr, type delta) \
{                                                                       \
    return pmix_atomic_ ## name ## _fetch_ ## suffix (addr, delta);     \
}                                                                       \
                                                                        \
__pmix_attribute_always_inline__ static __inline__ type pmix_thread_fetch_ ## name ## _ ## suffix (pmix_atomic_ ## type *addr, type delta) \
{                                                                       \
