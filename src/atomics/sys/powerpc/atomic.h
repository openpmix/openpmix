...
#        define PMIX_ATOMIC_POWERPC_DEFINE_ATOMIC_64(type, instr)                                \
            static inline int64_t pmix_atomic_fetch_##type##_64(pmix_atomic_int64_t *v,          \
                                                                int64_t val)                     \
            {                                                                                    \
                int64_t t, old;                                                                  \
                                                                                                 \
                                                          ...
                                                          int64_t *oldval, int64_t newval)
{
    ...
    __asm__ __volatile__("1: ldarx   %0, 0, %2  \n\t"
                         ...
                         "2:"
                         : "=&r"(prev), "=m"(*addr)
                         : "r"(addr), "r"(PMIX_ASM_VALUE64(*oldval)), "r"(PMIX_ASM_VALUE64(newval)),
                           "m"(*addr)
                         : "cc", "memory");
                                                          ...
                                                          int64_t *oldval, int64_t newval)
{
    ...
    __asm__ __volatile__("ld r4,%3         \n\t"
                         ...
                         "adde %0,r9,r5         \n\t"
                         : "=&r"(ret), "+r"(prev)
                         : "r" PMIX_ASM_ADDR(addr), "m"(*oldval), "m"(newval)
                         : "r4", "r5", "r9", "cc", "memory");
    *oldval = prev;
    return (bool) ret;
}
