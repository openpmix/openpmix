...
#ifndef PMIX_PTL_SERVER_H
#define PMIX_PTL_SERVER_H
...
} pmix_ptl_server_component_t;

extern pmix_ptl_server_component_t mca_ptl_server_component;

extern pmix_ptl_module_t pmix_ptl_server_module;

END_C_DECLS

#endif /* PMIX_PTL_SERVER_H */
