...
extern "C" {
     ...
     */
    struct pmix_compress_bzip_component_t {
        pmix_compress_base_component_t super;  /** Base COMPRESS component */

    };
    typedef struct pmix_compress_bzip_component_t pmix_compress_bzip_component_t;
    extern pmix_compress_bzip_component_t mca_compress_bzip_component;
