 ...
 */
const char *pmix_compress_bzip_component_version_string =
"PMIX COMPRESS bzip MCA component version " PMIX_VERSION;
 ...
 */
pmix_compress_bzip_component_t mca_compress_bzip_component = {
    /* First do the base component stuff */
    {
        ...
        .base_version = {
            ...
            .pmix_mca_component_name = "bzip",
            PMIX_MCA_BASE_MAKE_VERSION(component, PMIX_MAJOR_VERSION, PMIX_MINOR_VERSION,
                                       PMIX_RELEASE_VERSION),

            /* Component open and close functions */
            .pmix_mca_open_component = compress_bzip_open,
            .pmix_mca_close_component = compress_bzip_close,
            .pmix_mca_query_component = pmix_compress_bzip_component_query,
            .pmix_mca_register_component_params = compress_bzip_register
        },
        .base_data = {
...
static pmix_compress_base_module_t loc_module = {
    ...
    .init = pmix_compress_bzip_module_init,
    /** Finalization Function */
    .finalize = pmix_compress_bzip_module_finalize,

    /** Compress Function */
    .compress = pmix_compress_bzip_compress,
    .compress_nb = pmix_compress_bzip_compress_nb,

    /** Decompress Function */
    .decompress = pmix_compress_bzip_decompress,
    .decompress_nb = pmix_compress_bzip_decompress_nb,
...
static int compress_bzip_register (void)
{
    ...
    ret = pmix_mca_base_component_var_register (&mca_compress_bzip_component.super.base_version,
                                           "priority", "Priority of the COMPRESS bzip component "
                                           "(default: 10)", PMIX_MCA_BASE_VAR_TYPE_INT, NULL, 0,
...
static int compress_bzip_open(void)
{
    ...
    if ( 0 != mca_compress_bzip_component.super.verbose) {
        mca_compress_bzip_component.super.output_handle = pmix_output_open(NULL);
        pmix_output_set_verbosity(mca_compress_bzip_component.super.output_handle,
                                  mca_compress_bzip_component.super.verbose);
    } else {
        mca_compress_bzip_component.super.output_handle = pmix_compress_base_framework.framework_output;
    }
    ...
    pmix_output_verbose(10, mca_compress_bzip_component.super.output_handle,
                        "compress:bzip: open()");
    pmix_output_verbose(20, mca_compress_bzip_component.super.output_handle,
...
int pmix_compress_bzip_component_query(pmix_mca_base_module_t **module, int *priority)
{
