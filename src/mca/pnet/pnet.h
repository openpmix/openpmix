 ...
 */
/* The pnet framework interface version. It is stated here and
 * nowhere else: the component macro below stamps these numbers into
 * every pnet component, and the framework's declaration reaches the
...
#define PMIX_PNET_BASE_VERSION_1_0_0                                     \
    PMIX_MCA_BASE_VERSION_1_0_0("pnet", PMIX_MCA_pnet_MAJOR_VERSION,   \
                                PMIX_MCA_pnet_MINOR_VERSION,           \
                                PMIX_MCA_pnet_RELEASE_VERSION)
