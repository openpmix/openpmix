 ...
 */
/* The gds framework interface version. It is stated here and
 * nowhere else: the component macro below stamps these numbers into
 * every gds component, and the framework's declaration reaches the
...
#define PMIX_GDS_BASE_VERSION_1_0_0                                     \
    PMIX_MCA_BASE_VERSION_1_0_0("gds", PMIX_MCA_gds_MAJOR_VERSION,   \
                                PMIX_MCA_gds_MINOR_VERSION,           \
                                PMIX_MCA_gds_RELEASE_VERSION)
