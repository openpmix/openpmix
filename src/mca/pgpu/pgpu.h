 ...
 */
/* The pgpu framework interface version. It is stated here and
 * nowhere else: the component macro below stamps these numbers into
 * every pgpu component, and the framework's declaration reaches the
...
#define PMIX_PGPU_BASE_VERSION_1_0_0                                     \
    PMIX_MCA_BASE_VERSION_1_0_0("pgpu", PMIX_MCA_pgpu_MAJOR_VERSION,   \
                                PMIX_MCA_pgpu_MINOR_VERSION,           \
                                PMIX_MCA_pgpu_RELEASE_VERSION)
