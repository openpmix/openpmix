...
/* The pgpu framework interface version. It is stated here and nowhere
 * else: components stamp it into their struct with
 * PMIX_MCA_BASE_VERSION(pgpu), and the framework's declaration reaches
...
#define PMIX_MCA_pgpu_MAJOR_VERSION   3
