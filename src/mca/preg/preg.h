 ...
 */
/* The preg framework interface version. It is stated here and
 * nowhere else: the component macro below stamps these numbers into
 * every preg component, and the framework's declaration reaches the
...
#define PMIX_PREG_BASE_VERSION_1_0_0                                     \
    PMIX_MCA_BASE_VERSION_1_0_0("preg", PMIX_MCA_preg_MAJOR_VERSION,   \
                                PMIX_MCA_preg_MINOR_VERSION,           \
                                PMIX_MCA_preg_RELEASE_VERSION)
