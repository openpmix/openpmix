...
PMIX_CLASS_INSTANCE(pmix_mca_base_var_enum_flag_t, pmix_object_t,
...
static pmix_mca_base_var_enum_value_t verbose_values[] = {{PMIX_MCA_BASE_VERBOSE_NONE, "none"},
...
static int pmix_mca_base_var_enum_verbose_vfs(pmix_mca_base_var_enum_t *self,
...
static int enum_value_from_string(pmix_mca_base_var_enum_t *self, const char *string_value,
                                  int *value_out)
{
...
static int enum_string_from_value(pmix_mca_base_var_enum_t *self, const int value,
                                  char **string_value)
{
    int count, ret, i;
...
static int enum_get_value_flag(pmix_mca_base_var_enum_t *self, int index, int *value,
                               const char **string_value)
{
...
static int enum_value_from_string_flag(pmix_mca_base_var_enum_t *self, const char *string_value,
                                       int *value_out)
{
    pmix_mca_base_var_enum_flag_t *flag_enum = (pmix_mca_base_var_enum_flag_t *) self;
...
static int enum_string_from_value_flag(pmix_mca_base_var_enum_t *self, const int value,
                                       char **string_value)
{
    pmix_mca_base_var_enum_flag_t *flag_enum = (pmix_mca_base_var_enum_flag_t *) self;
