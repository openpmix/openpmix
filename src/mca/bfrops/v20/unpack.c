                                  ...
                                  pmix_data_type_t type)
{
    ...
    pmix_output_verbose(20, pmix_bfrops_base_framework.framework_output,
                        "pmix20_bfrop_unpack: found %d values for %d provided storage", local_num,
                        *num_vals);
    ...
    /** Unpack the value(s) */
    if (PMIX_SUCCESS
        != (rc = pmix20_bfrop_unpack_buffer(regtypes, buffer, dst, &local_num, type))) {
        *num_vals = 0;
        ret = rc;
    }
                                      ...
                                      void *dest, int32_t *num_vals, pmix_data_type_t type)
{
    ...
    if (remote_type == BFROP_TYPE_INT) {
        ...
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_buffer(regtypes, buffer, dest, num_vals,
                                                 BFROP_TYPE_INT))) {
        }
    } else {
                                ...
                                pmix_value_t *val)
{
    ...
    case PMIX_BOOL:
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_buffer(regtypes, buffer, &val->data.flag, &m,
                                                 PMIX_BOOL))) {
            return ret;
        }
        break;
    case PMIX_BYTE:
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_buffer(regtypes, buffer, &val->data.byte, &m,
                                                 PMIX_BYTE))) {
            return ret;
        }
        break;
    case PMIX_STRING:
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_buffer(regtypes, buffer, &val->data.string, &m,
                                                 PMIX_STRING))) {
            return ret;
        }
        break;
    case PMIX_SIZE:
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_buffer(regtypes, buffer, &val->data.size, &m,
                                                 PMIX_SIZE))) {
            return ret;
        }
        break;
    case PMIX_PID:
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_buffer(regtypes, buffer, &val->data.pid, &m, PMIX_PID))) {
            return ret;
        }
        break;
    case PMIX_INT:
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_buffer(regtypes, buffer, &val->data.integer, &m,
                                                 PMIX_INT))) {
            return ret;
        }
        break;
    case PMIX_INT8:
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_buffer(regtypes, buffer, &val->data.int8, &m,
                                                 PMIX_INT8))) {
            return ret;
        }
        break;
    case PMIX_INT16:
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_buffer(regtypes, buffer, &val->data.int16, &m,
                                                 PMIX_INT16))) {
            return ret;
        }
        break;
    case PMIX_INT32:
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_buffer(regtypes, buffer, &val->data.int32, &m,
                                                 PMIX_INT32))) {
            return ret;
        }
        break;
    case PMIX_INT64:
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_buffer(regtypes, buffer, &val->data.int64, &m,
                                                 PMIX_INT64))) {
            return ret;
        }
        break;
    case PMIX_UINT:
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_buffer(regtypes, buffer, &val->data.uint, &m,
                                                 PMIX_UINT))) {
            return ret;
        }
        break;
    case PMIX_UINT8:
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_buffer(regtypes, buffer, &val->data.uint8, &m,
                                                 PMIX_UINT8))) {
            return ret;
        }
        break;
    case PMIX_UINT16:
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_buffer(regtypes, buffer, &val->data.uint16, &m,
                                                 PMIX_UINT16))) {
            return ret;
        }
        break;
    case PMIX_UINT32:
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_buffer(regtypes, buffer, &val->data.uint32, &m,
                                                 PMIX_UINT32))) {
            return ret;
        }
        break;
    case PMIX_UINT64:
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_buffer(regtypes, buffer, &val->data.uint64, &m,
                                                 PMIX_UINT64))) {
            return ret;
        }
        break;
    case PMIX_FLOAT:
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_buffer(regtypes, buffer, &val->data.fval, &m,
                                                 PMIX_FLOAT))) {
            return ret;
        }
        break;
    case PMIX_DOUBLE:
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_buffer(regtypes, buffer, &val->data.dval, &m,
                                                 PMIX_DOUBLE))) {
            return ret;
        }
        break;
    case PMIX_TIMEVAL:
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_buffer(regtypes, buffer, &val->data.tv, &m,
                                                 PMIX_TIMEVAL))) {
            return ret;
        }
        break;
    case PMIX_TIME:
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_buffer(regtypes, buffer, &val->data.time, &m,
                                                 PMIX_TIME))) {
            return ret;
        }
        break;
    case PMIX_STATUS:
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_buffer(regtypes, buffer, &val->data.status, &m,
                                                 PMIX_STATUS))) {
            return ret;
        }
        break;
    case PMIX_PROC:
        ...
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_buffer(regtypes, buffer, val->data.proc, &m,
                                                 PMIX_PROC))) {
            return ret;
        }
        break;
    case PMIX_PROC_RANK:
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_buffer(regtypes, buffer, &val->data.rank, &m,
                                                 PMIX_PROC_RANK))) {
            return ret;
        }
        break;
    ...
    case PMIX_COMPRESSED_STRING:
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_buffer(regtypes, buffer, &val->data.bo, &m,
                                                 PMIX_BYTE_OBJECT))) {
            return ret;
        }
        break;
    ...
    case PMIX_POINTER:
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_buffer(regtypes, buffer, &val->data.ptr, &m,
                                                 PMIX_POINTER))) {
            return ret;
        }
        break;
    case PMIX_SCOPE:
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_buffer(regtypes, buffer, &val->data.scope, &m,
                                                 PMIX_SCOPE))) {
            return ret;
        }
        break;
    case PMIX_DATA_RANGE:
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_buffer(regtypes, buffer, &val->data.range, &m,
                                                 PMIX_DATA_RANGE))) {
            return ret;
        }
        break;
    case PMIX_PROC_STATE:
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_buffer(regtypes, buffer, &val->data.state, &m,
                                                 PMIX_PROC_STATE))) {
            return ret;
        }
        break;
    case PMIX_PROC_INFO:
        ...
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_buffer(regtypes, buffer, val->data.pinfo, &m,
                                                 PMIX_PROC_INFO))) {
            return ret;
        }
        break;
    case PMIX_DATA_ARRAY:
        ...
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_buffer(regtypes, buffer, val->data.darray, &m,
                                                 PMIX_DATA_ARRAY))) {
            return ret;
        }
        break;
    ...
    case PMIX_INFO_ARRAY:
        ...
        /* unpack into it */
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_buffer(regtypes, buffer, &val->data.darray->array, &m,
                                                 PMIX_INFO_ARRAY))) {
            return ret;
        }
        break;
                                       ...
                                       void *dest, int32_t *num_vals, pmix_data_type_t type)
{
    ...
    for (i = 0; i < n; ++i) {
        ...
        m = 1;
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_infodirs(regtypes, buffer, &ptr[i].flags, &m,
        ...
        m = 1;
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_int(regtypes, buffer, &ptr[i].value.type, &m,
                                              PMIX_INT))) {
            PMIX_ERROR_LOG(ret);
            return ret;
        }
                                        ...
                                        void *dest, int32_t *num_vals, pmix_data_type_t type)
{
    ...
    for (i = 0; i < n; ++i) {
        ...
        m = 1;
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_proc(regtypes, buffer, &ptr[i].proc, &m, PMIX_PROC))) {
            return ret;
        }
        /* unpack key */
        m = 1;
                                      ...
                                      void *dest, int32_t *num_vals, pmix_data_type_t type)
{
    ...
    for (i = 0; i < n; ++i) {
        ...
        m = 1;
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_sizet(regtypes, buffer, &nbytes, &m, PMIX_SIZE))) {
            return ret;
        }
        m = nbytes;
        ...
        if (0 < nbytes) {
            ...
            /* unpack the bytes */
            if (PMIX_SUCCESS
                != (ret = pmix20_bfrop_unpack_byte(regtypes, buffer, ptr[i].base_ptr, &m,
                                                   PMIX_BYTE))) {
                return ret;
            }
        }
                                       ...
                                       void *dest, int32_t *num_vals, pmix_data_type_t type)
{
    ...
    for (i = 0; i < n; ++i) {
        ...
        m = 1;
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_rank(regtypes, buffer, &ptr[i].rank, &m,
                                               PMIX_PROC_RANK))) {
            return ret;
        }
    }
                                      ...
                                      void *dest, int32_t *num_vals, pmix_data_type_t type)
{
    ...
    for (i = 0; i < n; ++i) {
        ...
        m = 1;
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_string(regtypes, buffer, &ptr[i].cmd, &m, PMIX_STRING))) {
            return ret;
        }
        /* unpack argc */
        m = 1;
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_int(regtypes, buffer, &nval, &m, PMIX_INT32))) {
            return ret;
        }
        /* unpack argv */
        for (k = 0; k < nval; k++) {
        ...
        m = 1;
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_string(regtypes, buffer, &ptr[i].cwd, &m, PMIX_STRING))) {
            return ret;
        }
        /* unpack maxprocs */
        m = 1;
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_int(regtypes, buffer, &ptr[i].maxprocs, &m, PMIX_INT))) {
            return ret;
        }
        /* unpack info array */
        m = 1;
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_sizet(regtypes, buffer, &ptr[i].ninfo, &m, PMIX_SIZE))) {
            return ret;
        }
        if (0 < ptr[i].ninfo) {
            ...
            m = ptr[i].ninfo;
            if (PMIX_SUCCESS
                != (ret = pmix20_bfrop_unpack_info(regtypes, buffer, ptr[i].info, &m, PMIX_INFO))) {
                return ret;
            }
        }
    }
                                       ...
                                       void *dest, int32_t *num_vals, pmix_data_type_t type)
{
    ...
    for (i = 0; i < n; ++i) {
        ...
        m = 1;
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_string(regtypes, buffer, &ptr[i].key, &m, PMIX_STRING))) {
            PMIX_ERROR_LOG(ret);
            return ret;
        }
        /* allocate the space */
        ...
        m = 1;
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_value(regtypes, buffer, ptr[i].value, &m, PMIX_VALUE))) {
            PMIX_ERROR_LOG(ret);
            return ret;
        }
    }
                                        ...
                                        void *dest, int32_t *num_vals, pmix_data_type_t type)
{
    ...
    for (i = 0; i < n; ++i) {
        ...
        m = 1;
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_sizet(regtypes, buffer, &ptr[i].size, &m, PMIX_SIZE))) {
            return ret;
        }
        if (0 < ptr[i].size) {
            ...
            m = ptr[i].size;
            if (PMIX_SUCCESS
                != (ret = pmix20_bfrop_unpack_byte(regtypes, buffer, ptr[i].blob, &m,
                                                   PMIX_UINT8))) {
                return ret;
            }
        }
                                     ...
                                     void *dest, int32_t *num_vals, pmix_data_type_t type)
{
    ...
    for (i = 0; i < n; ++i) {
        ...
        if (0 < ptr[i].size) {
            ...
            m = ptr[i].size;
            if (PMIX_SUCCESS
                != (ret = pmix20_bfrop_unpack_byte(regtypes, buffer, ptr[i].bytes, &m,
                                                   PMIX_BYTE))) {
                return ret;
            }
        }
                                        ...
                                        void *dest, int32_t *num_vals, pmix_data_type_t type)
{
    ...
    for (i = 0; i < n; ++i) {
        ...
        m = 1;
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_string(regtypes, buffer, &ptr[i].hostname, &m,
                                                 PMIX_STRING))) {
            return ret;
        }
        ...
        m = 1;
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_string(regtypes, buffer, &ptr[i].executable_name, &m,
                                                 PMIX_STRING))) {
            return ret;
        }
        /* unpack pid */
        m = 1;
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_pid(regtypes, buffer, &ptr[i].pid, &m, PMIX_PID))) {
            return ret;
        }
        /* unpack state */
        m = 1;
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_pstate(regtypes, buffer, &ptr[i].state, &m,
                                                 PMIX_PROC_STATE))) {
            return ret;
        }
    }
                                         ...
                                         void *dest, int32_t *num_vals, pmix_data_type_t type)
{
    ...
    for (i = 0; i < n; ++i) {
        ...
        m = 1;
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_datatype(regtypes, buffer, &ptr[i].type, &m,
                                                   PMIX_DATA_TYPE))) {
            return ret;
        }
        ...
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_buffer(regtypes, buffer, ptr[i].array, &m,
                                                 ptr[i].type))) {
            return ret;
        }
    }
                                        ...
                                        void *dest, int32_t *num_vals, pmix_data_type_t type)
{
    ...
    for (i = 0; i < n; ++i) {
        ...
        if (0 < nkeys) {
            ...
            m = nkeys;
            if (PMIX_SUCCESS
                != (ret = pmix20_bfrop_unpack_string(regtypes, buffer, ptr[i].keys, &m,
                                                     PMIX_STRING))) {
                return ret;
            }
        }
        ...
        m = 1;
        if (PMIX_SUCCESS
            != (ret = pmix20_bfrop_unpack_sizet(regtypes, buffer, &ptr[i].nqual, &m, PMIX_SIZE))) {
            return ret;
        }
        if (0 < ptr[i].nqual) {
            ...
            m = ptr[i].nqual;
            if (PMIX_SUCCESS
                != (ret = pmix20_bfrop_unpack_info(regtypes, buffer, ptr[i].qualifiers, &m,
                                                   PMIX_INFO))) {
                return ret;
            }
        }
                                        ...
                                        void *dest, int32_t *num_vals, pmix_data_type_t type)
{
    ...
    for (i = 0; i < n; ++i) {
        ...
        if (0 < ptr[i].size) {
            ...
            m = ptr[i].size;
            if (PMIX_SUCCESS
                != (ret = pmix20_bfrop_unpack_value(regtypes, buffer, ptr[i].array, &m,
                                                    PMIX_INFO))) {
                return ret;
            }
        }
