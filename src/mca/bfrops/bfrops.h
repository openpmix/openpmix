 ...
 */
/* The bfrops framework interface version. It is stated here and
 * nowhere else: the component macro below stamps these numbers into
 * every bfrops component, and the framework's declaration reaches the
...
#define PMIX_BFROPS_BASE_VERSION_1_0_0                                     \
    PMIX_MCA_BASE_VERSION_1_0_0("bfrops", PMIX_MCA_bfrops_MAJOR_VERSION,   \
                                PMIX_MCA_bfrops_MINOR_VERSION,           \
                                PMIX_MCA_bfrops_RELEASE_VERSION)
