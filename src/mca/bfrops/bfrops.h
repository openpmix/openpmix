...
typedef struct pmix_bfrops_module_t pmix_bfrops_module_t;


/****    COMPONENT STRUCTURE DEFINITION    ****/

/* define a component-level API for establishing a
 * communication rendezvous point for local procs */
typedef pmix_status_t (*pmix_bfrop_base_component_rendez_fn_t)(pmix_list_t *listeners, char *tmpdir);

/* define a component-level API for getting a module */
typedef pmix_bfrops_module_t* (*pmix_bfrop_base_component_assign_module_fn_t)(const char *version);
...
struct pmix_bfrops_base_component_t {
    ...
    pmix_bfrop_base_component_rendez_fn_t           rendezvous;
...
/* establish rendezvous points for the various protocols */
pmix_status_t pmix_bfrops_base_define_rendezvous(pmix_list_t *listeners, char *tmpdir);
...
/* Construct a buffer for a given peer */
pmix_buffer_t* pmix_bfrops_base_create_buffer(struct pmix_peer_t *pr);

void pmix_bfrops_base_construct_buffer(struct pmix_peer_t *pr, pmix_buffer_t *buf);
