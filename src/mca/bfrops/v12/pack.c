                                ...
                                pmix_data_type_t type)
{
    ...
    if (PMIX_SUCCESS
        != (rc = pmix12_bfrop_pack_int32(regtypes, buffer, &num_vals, 1, PMIX_INT32))) {
        return rc;
    }
                                       ...
                                       const void *src, int32_t num_vals, pmix_data_type_t type)
{
    ...
    pmix_output_verbose(20, pmix_globals.debug_output,
                        "pmix12_bfrop_pack_buffer( %p, %p, %lu, %d )\n", (void *) buffer, src,
                                       ...
                                       const void *src, int32_t num_vals, pmix_data_type_t type)
{
    ...
    for (i = 0; i < num_vals; ++i) {
        if (NULL == ssrc[i]) { /* got zero-length string/NULL pointer - store NULL */
            len = 0;
            if (PMIX_SUCCESS
                != (ret = pmix12_bfrop_pack_int32(regtypes, buffer, &len, 1, PMIX_INT32))) {
                return ret;
            }
        } else {
            ...
            if (PMIX_SUCCESS
                != (ret = pmix12_bfrop_pack_byte(regtypes, buffer, ssrc[i], len, PMIX_BYTE))) {
                return ret;
            }
        }
    }
                                      ...
                                      const void *src, int32_t num_vals, pmix_data_type_t type)
{
    ...
    for (i = 0; i < num_vals; ++i) {
        ...
        if (PMIX_SUCCESS
            != (ret = pmix12_bfrop_pack_string(regtypes, buffer, &convert, 1, PMIX_STRING))) {
            free(convert);
            return ret;
        }
        free(convert);
                                     ...
                                     const void *src, int32_t num_vals, pmix_data_type_t type)
{
    ...
    for (i = 0; i < num_vals; ++i) {
        ...
        if (PMIX_SUCCESS
            != (ret = pmix12_bfrop_pack_int64(regtypes, buffer, &ui64, 1, PMIX_UINT64))) {
            return ret;
        }
    }
                              ...
                              pmix_value_t *p)
{
    ...
    case PMIX_BOOL:
        if (PMIX_SUCCESS
            != (ret = pmix12_bfrop_pack_buffer(regtypes, buffer, &p->data.flag, 1, PMIX_BOOL))) {
            return ret;
        }
        break;
    case PMIX_BYTE:
        if (PMIX_SUCCESS
            != (ret = pmix12_bfrop_pack_buffer(regtypes, buffer, &p->data.byte, 1, PMIX_BYTE))) {
            return ret;
        }
        break;
    case PMIX_STRING:
        if (PMIX_SUCCESS
            != (ret = pmix12_bfrop_pack_buffer(regtypes, buffer, &p->data.string, 1,
                                               PMIX_STRING))) {
            return ret;
        }
        break;
    case PMIX_SIZE:
        if (PMIX_SUCCESS
            != (ret = pmix12_bfrop_pack_buffer(regtypes, buffer, &p->data.size, 1, PMIX_SIZE))) {
            return ret;
        }
        break;
    case PMIX_PID:
        if (PMIX_SUCCESS
            != (ret = pmix12_bfrop_pack_buffer(regtypes, buffer, &p->data.pid, 1, PMIX_PID))) {
            return ret;
        }
        break;
    case PMIX_INT:
        if (PMIX_SUCCESS
            != (ret = pmix12_bfrop_pack_buffer(regtypes, buffer, &p->data.integer, 1, PMIX_INT))) {
            return ret;
        }
        break;
    case PMIX_INT8:
        if (PMIX_SUCCESS
            != (ret = pmix12_bfrop_pack_buffer(regtypes, buffer, &p->data.int8, 1, PMIX_INT8))) {
            return ret;
        }
        break;
    case PMIX_INT16:
        if (PMIX_SUCCESS
            != (ret = pmix12_bfrop_pack_buffer(regtypes, buffer, &p->data.int16, 1, PMIX_INT16))) {
            return ret;
        }
        break;
    case PMIX_INT32:
        if (PMIX_SUCCESS
            != (ret = pmix12_bfrop_pack_buffer(regtypes, buffer, &p->data.int32, 1, PMIX_INT32))) {
            return ret;
        }
        break;
    case PMIX_INT64:
        if (PMIX_SUCCESS
            != (ret = pmix12_bfrop_pack_buffer(regtypes, buffer, &p->data.int64, 1, PMIX_INT64))) {
            return ret;
        }
        break;
    case PMIX_UINT:
        if (PMIX_SUCCESS
            != (ret = pmix12_bfrop_pack_buffer(regtypes, buffer, &p->data.uint, 1, PMIX_UINT))) {
            return ret;
        }
        break;
    case PMIX_UINT8:
        if (PMIX_SUCCESS
            != (ret = pmix12_bfrop_pack_buffer(regtypes, buffer, &p->data.uint8, 1, PMIX_UINT8))) {
            return ret;
        }
        break;
    case PMIX_UINT16:
        if (PMIX_SUCCESS
            != (ret = pmix12_bfrop_pack_buffer(regtypes, buffer, &p->data.uint16, 1,
                                               PMIX_UINT16))) {
            return ret;
        }
        break;
    case PMIX_UINT32:
        if (PMIX_SUCCESS
            != (ret = pmix12_bfrop_pack_buffer(regtypes, buffer, &p->data.uint32, 1,
                                               PMIX_UINT32))) {
            return ret;
        }
        break;
    case PMIX_UINT64:
        if (PMIX_SUCCESS
            != (ret = pmix12_bfrop_pack_buffer(regtypes, buffer, &p->data.uint64, 1,
                                               PMIX_UINT64))) {
            return ret;
        }
        break;
    case PMIX_FLOAT:
        if (PMIX_SUCCESS
            != (ret = pmix12_bfrop_pack_buffer(regtypes, buffer, &p->data.fval, 1, PMIX_FLOAT))) {
            return ret;
        }
        break;
    case PMIX_DOUBLE:
        if (PMIX_SUCCESS
            != (ret = pmix12_bfrop_pack_buffer(regtypes, buffer, &p->data.dval, 1, PMIX_DOUBLE))) {
            return ret;
        }
        break;
    case PMIX_TIMEVAL:
        if (PMIX_SUCCESS
            != (ret = pmix12_bfrop_pack_buffer(regtypes, buffer, &p->data.tv, 1, PMIX_TIMEVAL))) {
            return ret;
        }
        break;
    case PMIX_BYTE_OBJECT:
        if (PMIX_SUCCESS
            != (ret = pmix12_bfrop_pack_buffer(regtypes, buffer, &p->data.bo, 1,
                                               PMIX_BYTE_OBJECT))) {
            return ret;
        }
        break;
    case PMIX_DATA_ARRAY:
        ...
        if (PMIX_SUCCESS
            != (ret = pmix12_bfrop_pack_buffer(regtypes, buffer, &array, 1, PMIX_INFO_ARRAY))) {
            return ret;
        }
        break;
    ...
    case PMIX_PROC_RANK:
        ...
        rank = p->data.rank;
        if (PMIX_SUCCESS
            != (ret = pmix12_bfrop_pack_buffer(regtypes, buffer, &rank, 1, PMIX_INT))) {
            return ret;
        }
        break;
                                     ...
                                     const void *src, int32_t num_vals, pmix_data_type_t type)
{
    ...
    for (i = 0; i < num_vals; ++i) {
        ...
        foo = info[i].key;
        if (PMIX_SUCCESS
            != (ret = pmix12_bfrop_pack_string(regtypes, buffer, &foo, 1, PMIX_STRING))) {
            return ret;
        }
        /* pack the type - unfortunately, v1.2 directly packed the int instead of
         * using the store_data_type function. This means we lose the translation!
                                      ...
                                      const void *src, int32_t num_vals, pmix_data_type_t type)
{
    ...
    for (i = 0; i < num_vals; ++i) {
        /* pack the proc */
        if (PMIX_SUCCESS
            != (ret = pmix12_bfrop_pack_proc(regtypes, buffer, &pdata[i].proc, 1, PMIX_PROC))) {
            return ret;
        }
        /* pack key */
        foo = pdata[i].key;
                                    ...
                                    const void *src, int32_t num_vals, pmix_data_type_t type)
{
    ...
    for (i = 0; i < num_vals; ++i) {
        ...
        if (PMIX_SUCCESS
            != (ret = pmix12_bfrop_pack_sizet(regtypes, buffer, &ptr[i].bytes_used, 1,
                                              PMIX_SIZE))) {
            return ret;
        }
        /* pack the bytes */
        if (0 < ptr[i].bytes_used) {
            if (PMIX_SUCCESS
                != (ret = pmix12_bfrop_pack_byte(regtypes, buffer, ptr[i].base_ptr,
                                     ...
                                     const void *src, int32_t num_vals, pmix_data_type_t type)
{
    ...
    for (i = 0; i < num_vals; ++i) {
        ...
        if (PMIX_SUCCESS
            != (ret = pmix12_bfrop_pack_string(regtypes, buffer, &ptr, 1, PMIX_STRING))) {
            return ret;
        }
        if (PMIX_SUCCESS
            != (ret = pmix12_bfrop_pack_int(regtypes, buffer, &proc[i].rank, 1, PMIX_INT))) {
            return ret;
        }
    }
    return PMIX_SUCCESS;
                                    ...
                                    const void *src, int32_t num_vals, pmix_data_type_t type)
{
    ...
    for (i = 0; i < num_vals; ++i) {
        if (PMIX_SUCCESS
            != (ret = pmix12_bfrop_pack_string(regtypes, buffer, &app[i].cmd, 1, PMIX_STRING))) {
            return ret;
        }
        /* argv */
        ...
        for (j = 0; j < argc; j++) {
            if (PMIX_SUCCESS
                != (ret = pmix12_bfrop_pack_string(regtypes, buffer, &app[i].argv[j], 1,
                                                   PMIX_STRING))) {
                return ret;
            }
        }
        ...
        for (j = 0; j < nvals; j++) {
            if (PMIX_SUCCESS
                != (ret = pmix12_bfrop_pack_string(regtypes, buffer, &app[i].env[j], 1,
                                                   PMIX_STRING))) {
                return ret;
            }
        }
        /* maxprocs */
        if (PMIX_SUCCESS
            != (ret = pmix12_bfrop_pack_int(regtypes, buffer, &app[i].maxprocs, 1, PMIX_INT))) {
            return ret;
        }
        /* info array */
        if (PMIX_SUCCESS
            != (ret = pmix12_bfrop_pack_sizet(regtypes, buffer, &app[i].ninfo, 1, PMIX_SIZE))) {
            return ret;
        }
        if (0 < app[i].ninfo) {
            if (PMIX_SUCCESS
                != (ret = pmix12_bfrop_pack_info(regtypes, buffer, app[i].info, app[i].ninfo,
                                                 PMIX_INFO))) {
                return ret;
            }
        }
                                     ...
                                     const void *src, int32_t num_vals, pmix_data_type_t type)
{
    ...
    for (i = 0; i < num_vals; ++i) {
        /* pack the key */
        if (PMIX_SUCCESS
            != (ret = pmix12_bfrop_pack_string(regtypes, buffer, &ptr[i].key, 1, PMIX_STRING))) {
            return ret;
        }
        /* pack the value */
        if (PMIX_SUCCESS
            != (ret = pmix12_bfrop_pack_value(regtypes, buffer, ptr[i].value, 1,
                                              ptr[i].value->type))) {
            return ret;
        }
    }
                                      ...
                                      const void *src, int32_t num_vals, pmix_data_type_t type)
{
    ...
    for (i = 0; i < num_vals; ++i) {
        /* pack the size */
        if (PMIX_SUCCESS
            != (ret = pmix12_bfrop_pack_sizet(regtypes, buffer, &ptr[i].size, 1, PMIX_SIZE))) {
            return ret;
        }
        if (0 < ptr[i].size) {
            /* pack the values */
            if (PMIX_SUCCESS
                != (ret = pmix12_bfrop_pack_info(regtypes, buffer, ptr[i].array, ptr[i].size,
                                                 PMIX_INFO))) {
                return ret;
            }
        }
                                      ...
                                      const void *src, int32_t num_vals, pmix_data_type_t type)
{
    ...
    for (i = 0; i < num_vals; ++i) {
        ...
        if (0 < ptr[i].size) {
            if (PMIX_SUCCESS
                != (ret = pmix12_bfrop_pack_byte(regtypes, buffer, ptr[i].blob, ptr[i].size,
                                                 PMIX_UINT8))) {
                return ret;
            }
        }
                                   ...
                                   const void *src, int32_t num_vals, pmix_data_type_t type)
{
    ...
    for (i = 0; i < num_vals; i++) {
        if (PMIX_SUCCESS
            != (ret = pmix12_bfrop_pack_sizet(regtypes, buffer, &bo[i].size, 1, PMIX_SIZE))) {
            return ret;
        }
        if (0 < bo[i].size) {
            if (PMIX_SUCCESS
                != (ret = pmix12_bfrop_pack_byte(regtypes, buffer, bo[i].bytes, bo[i].size,
                                                 PMIX_BYTE))) {
                return ret;
            }
        }
