...
static pmix_status_t pmix401_pack(pmix_buffer_t *buffer,
                                const void *src, int num_vals,
                                pmix_data_type_t type);
static pmix_status_t pmix401_unpack(pmix_buffer_t *buffer, void *dest,
                                  int32_t *num_vals, pmix_data_type_t type);
static pmix_status_t pmix401_copy(void **dest, void *src,
                                pmix_data_type_t type);
static pmix_status_t pmix401_print(char **output, char *prefix,
...
pmix401_bfrops_base_pack_general_int(pmix_pointer_array_t *regtypes,
                                   pmix_buffer_t *buffer, const void *src,
                                   int32_t num_vals, pmix_data_type_t type);
static pmix_status_t
pmix401_bfrops_base_pack_int(pmix_pointer_array_t *regtypes,
                           pmix_buffer_t *buffer, const void *src,
                           int32_t num_vals, pmix_data_type_t type);
static pmix_status_t
pmix401_bfrops_base_pack_sizet(pmix_pointer_array_t *regtypes,
                             pmix_buffer_t *buffer, const void *src,
                             int32_t num_vals, pmix_data_type_t type);
static pmix_status_t
pmix401_bfrops_base_unpack_general_int(pmix_pointer_array_t *regtypes,
                                     pmix_buffer_t *buffer, void *dest,
                                     int32_t *num_vals, pmix_data_type_t type);
static pmix_status_t
pmix401_bfrops_base_unpack_int(pmix_pointer_array_t *regtypes,
                             pmix_buffer_t *buffer, void *dest,
                             int32_t *num_vals, pmix_data_type_t type);
static pmix_status_t
pmix401_bfrops_base_unpack_sizet(pmix_pointer_array_t *regtypes,
                               pmix_buffer_t *buffer, void *dest,
                               int32_t *num_vals, pmix_data_type_t type);

pmix_bfrops_module_t pmix_bfrops_pmix401_module = {
    .version = "v401",
    .init = init,
    .finalize = finalize,
    .pack = pmix401_pack,
...
static pmix_status_t init(void)
{
    ...
    PMIX_REGISTER_TYPE("PMIX_SIZE", PMIX_SIZE,
                       pmix401_bfrops_base_pack_sizet,
                       pmix401_bfrops_base_unpack_sizet,
                       pmix_bfrops_base_std_copy,
    ...
    PMIX_REGISTER_TYPE("PMIX_INT", PMIX_INT,
                       pmix401_bfrops_base_pack_int,
                       pmix401_bfrops_base_unpack_int,
                       pmix_bfrops_base_std_copy,
    ...
    PMIX_REGISTER_TYPE("PMIX_INT16", PMIX_INT16,
                       pmix401_bfrops_base_pack_general_int,
                       pmix401_bfrops_base_unpack_general_int,
                       pmix_bfrops_base_std_copy,
...
static void finalize(void)
{
    ...
    for (n=0; n < mca_bfrops_v401_component.types.size; n++) {
        if (NULL != (info = (pmix_bfrop_type_info_t*)pmix_pointer_array_get_item(&mca_bfrops_v401_component.types, n))) {
            PMIX_RELEASE(info);
                                ...
                                pmix_data_type_t type)
{
    ...
    return pmix_bfrops_base_pack(&mca_bfrops_v401_component.types,
...
{
     /* kick the process off by passing this in to the base */
    return pmix_bfrops_base_unpack(&mca_bfrops_v401_component.types,
...
static pmix_status_t pmix401_copy(void **dest, void *src,
                                pmix_data_type_t type)
{
    return pmix_bfrops_base_copy(&mca_bfrops_v401_component.types,
                                 dest, src, type);
}
...
static pmix_status_t pmix401_print(char **output, char *prefix,
                                 void *src, pmix_data_type_t type)
{
    return pmix_bfrops_base_print(&mca_bfrops_v401_component.types,
