...
static pmix_status_t pmix401_pack(pmix_buffer_t *buffer, const void *src, int num_vals,
                                  pmix_data_type_t type);
static pmix_status_t pmix401_unpack(pmix_buffer_t *buffer, void *dest, int32_t *num_vals,
                                    pmix_data_type_t type);
static pmix_status_t pmix401_copy(void **dest, void *src, pmix_data_type_t type);
static pmix_status_t pmix401_print(char **output, char *prefix, void *src, pmix_data_type_t type);
...
static pmix_status_t pmix401_bfrops_base_pack_general_int(pmix_pointer_array_t *regtypes,
                                                          pmix_buffer_t *buffer, const void *src,
                                                          int32_t num_vals, pmix_data_type_t type);
static pmix_status_t pmix401_bfrops_base_pack_int(pmix_pointer_array_t *regtypes,
                                                  pmix_buffer_t *buffer, const void *src,
                                                  int32_t num_vals, pmix_data_type_t type);
static pmix_status_t pmix401_bfrops_base_pack_sizet(pmix_pointer_array_t *regtypes,
                                                    pmix_buffer_t *buffer, const void *src,
                                                    int32_t num_vals, pmix_data_type_t type);
static pmix_status_t pmix401_bfrops_base_unpack_general_int(pmix_pointer_array_t *regtypes,
                                                            pmix_buffer_t *buffer, void *dest,
                                                            int32_t *num_vals,
                                                            pmix_data_type_t type);
static pmix_status_t pmix401_bfrops_base_unpack_int(pmix_pointer_array_t *regtypes,
                                                    pmix_buffer_t *buffer, void *dest,
                                                    int32_t *num_vals, pmix_data_type_t type);
static pmix_status_t pmix401_bfrops_base_unpack_sizet(pmix_pointer_array_t *regtypes,
                                                      pmix_buffer_t *buffer, void *dest,
                                                      int32_t *num_vals, pmix_data_type_t type);

pmix_bfrops_module_t pmix_bfrops_pmix401_module = {.version = "v401",
                                                   .init = init,
                                                   .finalize = finalize,
                                                   .pack = pmix401_pack,
                                                   .unpack = pmix401_unpack,
                                                   .copy = pmix401_copy,
                                                   .print = pmix401_print,
...
static pmix_status_t init(void)
{
    ...
    PMIX_REGISTER_TYPE("PMIX_STRING", PMIX_STRING, pmix_bfrops_base_pack_string,
                       ...
                       pmix_bfrops_base_print_string, &mca_bfrops_v401_component.types);

    /* Register the rest of the standard generic types to point to internal functions */
    PMIX_REGISTER_TYPE("PMIX_SIZE", PMIX_SIZE, pmix401_bfrops_base_pack_sizet,
                       pmix401_bfrops_base_unpack_sizet, pmix_bfrops_base_std_copy,
                       pmix_bfrops_base_print_size, &mca_bfrops_v401_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_PID", PMIX_PID, pmix_bfrops_base_pack_pid, pmix_bfrops_base_unpack_pid,
                       ...
                       &mca_bfrops_v401_component.types);

    PMIX_REGISTER_TYPE("PMIX_INT", PMIX_INT, pmix401_bfrops_base_pack_int,
                       pmix401_bfrops_base_unpack_int, pmix_bfrops_base_std_copy,
                       pmix_bfrops_base_print_int, &mca_bfrops_v401_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_INT8", PMIX_INT8, pmix_bfrops_base_pack_byte,
                       pmix_bfrops_base_unpack_byte, pmix_bfrops_base_std_copy,
                       pmix_bfrops_base_print_int8, &mca_bfrops_v401_component.types);

    PMIX_REGISTER_TYPE("PMIX_INT16", PMIX_INT16, pmix401_bfrops_base_pack_general_int,
                       pmix401_bfrops_base_unpack_general_int, pmix_bfrops_base_std_copy,
                       pmix_bfrops_base_print_int16, &mca_bfrops_v401_component.types);

    PMIX_REGISTER_TYPE("PMIX_INT32", PMIX_INT32, pmix401_bfrops_base_pack_general_int,
                       pmix401_bfrops_base_unpack_general_int, pmix_bfrops_base_std_copy,
                       pmix_bfrops_base_print_int32, &mca_bfrops_v401_component.types);

    PMIX_REGISTER_TYPE("PMIX_INT64", PMIX_INT64, pmix401_bfrops_base_pack_general_int,
                       pmix401_bfrops_base_unpack_general_int, pmix_bfrops_base_std_copy,
                       pmix_bfrops_base_print_int64, &mca_bfrops_v401_component.types);

    PMIX_REGISTER_TYPE("PMIX_UINT", PMIX_UINT, pmix401_bfrops_base_pack_int,
                       pmix401_bfrops_base_unpack_int, pmix_bfrops_base_std_copy,
                       pmix_bfrops_base_print_uint, &mca_bfrops_v401_component.types);

    PMIX_REGISTER_TYPE("PMIX_UINT8", PMIX_UINT8, pmix_bfrops_base_pack_byte,
                       pmix_bfrops_base_unpack_byte, pmix_bfrops_base_std_copy,
                       pmix_bfrops_base_print_uint8, &mca_bfrops_v401_component.types);

    PMIX_REGISTER_TYPE("PMIX_UINT16", PMIX_UINT16, pmix401_bfrops_base_pack_general_int,
                       pmix401_bfrops_base_unpack_general_int, pmix_bfrops_base_std_copy,
                       pmix_bfrops_base_print_uint16, &mca_bfrops_v401_component.types);

    PMIX_REGISTER_TYPE("PMIX_UINT32", PMIX_UINT32, pmix401_bfrops_base_pack_general_int,
                       pmix401_bfrops_base_unpack_general_int, pmix_bfrops_base_std_copy,
                       pmix_bfrops_base_print_uint32, &mca_bfrops_v401_component.types);

    PMIX_REGISTER_TYPE("PMIX_UINT64", PMIX_UINT64, pmix401_bfrops_base_pack_general_int,
                       pmix401_bfrops_base_unpack_general_int, pmix_bfrops_base_std_copy,
                       pmix_bfrops_base_print_uint64, &mca_bfrops_v401_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_FLOAT", PMIX_FLOAT, pmix_bfrops_base_pack_float,
                       ...
                       pmix_bfrops_base_print_float, &mca_bfrops_v401_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_DOUBLE", PMIX_DOUBLE, pmix_bfrops_base_pack_double,
                       ...
                       pmix_bfrops_base_print_double, &mca_bfrops_v401_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_TIMEVAL", PMIX_TIMEVAL, pmix_bfrops_base_pack_timeval,
                       ...
                       pmix_bfrops_base_print_timeval, &mca_bfrops_v401_component.types);

    PMIX_REGISTER_TYPE("PMIX_TIME", PMIX_TIME, pmix_bfrops_base_pack_time,
                       pmix_bfrops_base_unpack_time, pmix_bfrops_base_std_copy,
                       pmix_bfrops_base_print_time, &mca_bfrops_v401_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_STATUS", PMIX_STATUS, pmix_bfrops_base_pack_status,
                       ...
                       pmix_bfrops_base_print_status, &mca_bfrops_v401_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_INFO", PMIX_INFO, pmix_bfrops_base_pack_info,
                       ...
                       pmix_bfrops_base_print_info, &mca_bfrops_v401_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_PDATA", PMIX_PDATA, pmix_bfrops_base_pack_pdata,
                       ...
                       pmix_bfrops_base_print_pdata, &mca_bfrops_v401_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_BUFFER", PMIX_BUFFER, pmix_bfrops_base_pack_buf,
                       ...
                       pmix_bfrops_base_print_buf, &mca_bfrops_v401_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_PERSIST", PMIX_PERSIST, pmix_bfrops_base_pack_persist,
                       ...
                       pmix_bfrops_base_print_persist, &mca_bfrops_v401_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_POINTER", PMIX_POINTER, pmix_bfrops_base_pack_ptr,
                       ...
                       pmix_bfrops_base_print_ptr, &mca_bfrops_v401_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_SCOPE", PMIX_SCOPE, pmix_bfrops_base_pack_scope,
                       ...
                       pmix_bfrops_base_std_copy, &mca_bfrops_v401_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_COMMAND", PMIX_COMMAND, pmix_bfrops_base_pack_cmd,
                       ...
                       pmix_bfrops_base_print_cmd, &mca_bfrops_v401_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_INFO_DIRECTIVES", PMIX_INFO_DIRECTIVES,
                       ...
                       pmix_bfrops_base_print_info_directives, &mca_bfrops_v401_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_DATA_TYPE", PMIX_DATA_TYPE, pmix_bfrops_base_pack_datatype,
                       ...
                       pmix_bfrops_base_print_datatype, &mca_bfrops_v401_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_PROC_STATE", PMIX_PROC_STATE, pmix_bfrops_base_pack_pstate,
                       ...
                       pmix_bfrops_base_print_pstate, &mca_bfrops_v401_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_PROC_INFO", PMIX_PROC_INFO, pmix_bfrops_base_pack_pinfo,
                       ...
                       pmix_bfrops_base_print_pinfo, &mca_bfrops_v401_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_DATA_ARRAY", PMIX_DATA_ARRAY, pmix_bfrops_base_pack_darray,
                       ...
                       pmix_bfrops_base_print_darray, &mca_bfrops_v401_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_PROC_RANK", PMIX_PROC_RANK, pmix_bfrops_base_pack_rank,
                       ...
                       pmix_bfrops_base_print_rank, &mca_bfrops_v401_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_QUERY", PMIX_QUERY, pmix_bfrops_base_pack_query,
                       ...
                       pmix_bfrops_base_print_query, &mca_bfrops_v401_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_ALLOC_DIRECTIVE", PMIX_ALLOC_DIRECTIVE,
                       ...
                       pmix_bfrops_base_print_alloc_directive, &mca_bfrops_v401_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_IOF_CHANNEL", PMIX_IOF_CHANNEL, pmix_bfrops_base_pack_iof_channel,
                       ...
                       pmix_bfrops_base_print_iof_channel, &mca_bfrops_v401_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_ENVAR", PMIX_ENVAR, pmix_bfrops_base_pack_envar,
                       ...
                       pmix_bfrops_base_print_envar, &mca_bfrops_v401_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_COORD", PMIX_COORD, pmix_bfrops_base_pack_coord,
                       ...
                       pmix_bfrops_base_print_coord, &mca_bfrops_v401_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_REGATTR", PMIX_REGATTR, pmix_bfrops_base_pack_regattr,
                       ...
                       pmix_bfrops_base_print_regattr, &mca_bfrops_v401_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_REGEX", PMIX_REGEX, pmix_bfrops_base_pack_regex,
                       ...
                       pmix_bfrops_base_print_regex, &mca_bfrops_v401_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_JOB_STATE", PMIX_JOB_STATE, pmix_bfrops_base_pack_jobstate,
                       ...
                       pmix_bfrops_base_print_jobstate, &mca_bfrops_v401_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_LINK_STATE", PMIX_LINK_STATE, pmix_bfrops_base_pack_linkstate,
                       ...
                       pmix_bfrops_base_print_linkstate, &mca_bfrops_v401_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_PROC_CPUSET", PMIX_PROC_CPUSET, pmix_bfrops_base_pack_cpuset,
                       ...
                       pmix_bfrops_base_print_cpuset, &mca_bfrops_v401_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_GEOMETRY", PMIX_GEOMETRY, pmix_bfrops_base_pack_geometry,
                       ...
                       pmix_bfrops_base_print_geometry, &mca_bfrops_v401_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_DEVICE_DIST", PMIX_DEVICE_DIST, pmix_bfrops_base_pack_devdist,
                       ...
                       pmix_bfrops_base_print_devdist, &mca_bfrops_v401_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_ENDPOINT", PMIX_ENDPOINT, pmix_bfrops_base_pack_endpoint,
                       ...
                       pmix_bfrops_base_print_endpoint, &mca_bfrops_v401_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_TOPO", PMIX_TOPO, pmix_bfrops_base_pack_topology,
                       ...
                       pmix_bfrops_base_print_topology, &mca_bfrops_v401_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_DEVTYPE", PMIX_DEVTYPE, pmix_bfrops_base_pack_devtype,
                       ...
                       pmix_bfrops_base_print_devtype, &mca_bfrops_v401_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_LOCTYPE", PMIX_LOCTYPE, pmix_bfrops_base_pack_locality,
                       ...
                       pmix_bfrops_base_print_locality, &mca_bfrops_v401_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_PROC_NSPACE", PMIX_PROC_NSPACE, pmix_bfrops_base_pack_nspace,
                       ...
                       pmix_bfrops_base_print_nspace, &mca_bfrops_v401_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_DATA_BUFFER", PMIX_DATA_BUFFER, pmix_bfrops_base_pack_dbuf,
                       ...
                       pmix_bfrops_base_print_dbuf, &mca_bfrops_v401_component.types);
...
static void finalize(void)
{
    ...
    for (n = 0; n < mca_bfrops_v401_component.types.size; n++) {
        if (NULL
            != (info = (pmix_bfrop_type_info_t *)
                    pmix_pointer_array_get_item(&mca_bfrops_v401_component.types, n))) {
            PMIX_RELEASE(info);
            pmix_pointer_array_set_item(&mca_bfrops_v401_component.types, n, NULL);
        }
    }
}
                                  ...
                                  pmix_data_type_t type)
{
    ...
    return pmix_bfrops_base_pack(&mca_bfrops_v401_component.types, buffer, src, num_vals, type);
}
...
{
    /* kick the process off by passing this in to the base */
    return pmix_bfrops_base_unpack(&mca_bfrops_v401_component.types, buffer, dest, num_vals, type);
}

static pmix_status_t pmix401_copy(void **dest, void *src, pmix_data_type_t type)
{
    return pmix_bfrops_base_copy(&mca_bfrops_v401_component.types, dest, src, type);
}

static pmix_status_t pmix401_print(char **output, char *prefix, void *src, pmix_data_type_t type)
{
    return pmix_bfrops_base_print(&mca_bfrops_v401_component.types, output, prefix, src, type);
}
...
static pmix_status_t register_type(const char *name, pmix_data_type_t type,
                                   ...
                                   pmix_bfrop_copy_fn_t copy, pmix_bfrop_print_fn_t print)
{
    PMIX_REGISTER_TYPE(name, type, pack, unpack, copy, print, &mca_bfrops_v401_component.types);
    return PMIX_SUCCESS;
}

static const char *data_type_string(pmix_data_type_t type)
{
    return pmix_bfrops_base_data_type_string(&mca_bfrops_v401_component.types, type);
}
