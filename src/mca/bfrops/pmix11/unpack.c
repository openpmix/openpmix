...
pmix_status_t pmix11_unpack(pmix_buffer_t *buffer, void *dest,
                            int32_t *num_vals, pmix_data_type_t type)
{
     /* kick the process off by passing this in to the base */
    return pmix_bfrops_base_unpack(&mca_bfrops_pmix11_component.types,
                                   buffer, dest, num_vals, type);
}

pmix_status_t pmix11_unpack_info(pmix_buffer_t *buffer, void *dest,
                                 int32_t *num_vals, pmix_data_type_t type)
{
    pmix_info_t *ptr;
    int32_t i, n, m;
    ...
    for (i = 0; i < n; ++i) {
        ...
        if (PMIX_INFO_ARRAY == ptr[i].value.type) {
            m=1;
            if (PMIX_SUCCESS != (ret = pmix11_unpack_array(buffer, &ptr[i].value, &m, PMIX_INFO_ARRAY))) {
                return ret;
            }
        } else {
...
pmix_status_t pmix11_unpack_pdata(pmix_buffer_t *buffer, void *dest,
                                  int32_t *num_vals, pmix_data_type_t type)
{
    pmix_pdata_t *ptr;
    int32_t i, n, m;
    ...
    for (i = 0; i < n; ++i) {
        ...
        if (PMIX_INFO_ARRAY == ptr[i].value.type) {
            m=1;
            if (PMIX_SUCCESS != (ret = pmix11_unpack_array(buffer, &ptr[i].value.data.array, &m, PMIX_INFO_ARRAY))) {
                return ret;
            }
        } else {
            if (PMIX_SUCCESS != (ret = pmix_bfrops_base_unpack_val(buffer, &ptr[i].value))) {
...
pmix_status_t pmix11_unpack_app(pmix_buffer_t *buffer, void *dest,
                                int32_t *num_vals, pmix_data_type_t type)
{
    pmix_app_t *ptr;
    int32_t i, k, n, m;
    ...
    for (i = 0; i < n; ++i) {
        ...
        if (0 < ptr[i].ninfo) {
            ...
            m = ptr[i].ninfo;
            if (PMIX_SUCCESS != (ret = pmix11_unpack_info(buffer, ptr[i].info, &m, PMIX_INFO))) {
                return ret;
            }
        }
    }
...
pmix_status_t pmix11_unpack_kval(pmix_buffer_t *buffer, void *dest,
                                 int32_t *num_vals, pmix_data_type_t type)
{
    pmix_kval_t *ptr;
    int32_t i, n, m;
...
pmix_status_t pmix11_unpack_array(pmix_buffer_t *buffer, void *dest,
                                  int32_t *num_vals, pmix_data_type_t type)
{
    ...
    for (i = 0; i < n; ++i) {
        ...
        if (0 < ptr[i].size) {
            ...
            m=ptr[i].size;
            if (PMIX_SUCCESS != (ret = pmix11_unpack_info(buffer, ptr[i].array, &m, PMIX_INFO))) {
                return ret;
            }
        }
    }
...
pmix_status_t pmix11_unpack_persist(pmix_buffer_t *buffer, void *dest,
                                    int32_t *num_vals, pmix_data_type_t type)
{
    return pmix_bfrops_base_unpack(&mca_bfrops_pmix11_component.types,
...
pmix_status_t pmix11_unpack_datatype(pmix_buffer_t *buffer,
...
pmix_status_t pmix11_unpack_scope(pmix_buffer_t *buffer, void *dest,
                                  int32_t *num_vals, pmix_data_type_t type)
{
    return pmix_bfrops_base_unpack(&mca_bfrops_pmix11_component.types,
...
pmix_status_t pmix11_unpack_range(pmix_buffer_t *buffer, void *dest,
                                  int32_t *num_vals, pmix_data_type_t type)
{
    return pmix_bfrops_base_unpack(&mca_bfrops_pmix11_component.types,
                                   buffer, dest, num_vals, PMIX_UINT);
...
pmix_status_t pmix11_unpack_cmd(pmix_buffer_t *buffer, void *dest,
                                int32_t *num_vals, pmix_data_type_t type)
{
    return pmix_bfrops_base_unpack(&mca_bfrops_pmix11_component.types,
...
pmix_status_t pmix11_unpack_info_directives(pmix_buffer_t *buffer, void *dest,
                                            int32_t *num_vals, pmix_data_type_t type)
{
    return PMIX_SUCCESS;
}
