...
pmix_bfrops_module_t pmix_bfrops_pmix11_module = {
    .name = "pmix11",
    .init = init,
    .finalize = finalize,
    .pack = pmix11_pack,
    .unpack = pmix11_unpack,
    .copy = pmix11_copy,
    .print = pmix11_print,
...
static pmix_status_t init(void)
{
    ...
    PMIX_REGISTER_TYPE("PMIX_BOOL", PMIX_BOOL,
                       ...
                       &mca_bfrops_pmix11_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_HWLOC_TOPO", PMIX_HWLOC_TOPO,
                       pmix_bfrops_base_pack_topo,
                       pmix_bfrops_base_unpack_topo,
                       pmix_bfrops_base_copy_topo,
                       pmix_bfrops_base_print_topo,
                       &mca_bfrops_pmix11_component.types);
#endif
    ...
    PMIX_REGISTER_TYPE("PMIX_INFO_ARRAY", PMIX_INFO_ARRAY,
                       pmix11_pack_array, pmix11_unpack_array,
    ...
    PMIX_REGISTER_TYPE("PMIX_KVAL", PMIX_KVAL,
                       pmix11_pack_kval, pmix11_unpack_kval,
    ...
    PMIX_REGISTER_TYPE("PMIX_INFO_DIRECTIVES", PMIX_INFO_DIRECTIVES,
                       pmix11_pack_info_directives,
                       pmix11_unpack_info_directives,
                       pmix_bfrops_base_std_copy,
...
static void finalize(void)
{
    ...
    for (n=0; n < mca_bfrops_pmix11_component.types.size; n++) {
        if (NULL != (info = (pmix_bfrop_type_info_t*)pmix_pointer_array_get_item(&mca_bfrops_pmix11_component.types, n))) {
            PMIX_RELEASE(info);
            pmix_pointer_array_set_item(&mca_bfrops_pmix11_component.types, n, NULL);
        }
    }
}
