...
static pmix_status_t pmix32_pack(pmix_buffer_t *buffer,
                                 const void *src, int num_vals,
                                 pmix_data_type_t type);
static pmix_status_t pmix32_unpack(pmix_buffer_t *buffer, void *dest,
                                   int32_t *num_vals, pmix_data_type_t type);
static pmix_status_t pmix32_copy(void **dest, void *src,
                                 pmix_data_type_t type);
static pmix_status_t pmix32_print(char **output, char *prefix,
...
pmix31_bfrops_base_pack_general_int(pmix_pointer_array_t *regtypes,
                                    pmix_buffer_t *buffer, const void *src,
                                    int32_t num_vals, pmix_data_type_t type);
static pmix_status_t
pmix31_bfrops_base_pack_int(pmix_pointer_array_t *regtypes,
                            pmix_buffer_t *buffer, const void *src,
                            int32_t num_vals, pmix_data_type_t type);
static pmix_status_t
pmix31_bfrops_base_pack_sizet(pmix_pointer_array_t *regtypes,
                              pmix_buffer_t *buffer, const void *src,
                              int32_t num_vals, pmix_data_type_t type);
static pmix_status_t
pmix31_bfrops_base_unpack_general_int(pmix_pointer_array_t *regtypes,
                                      pmix_buffer_t *buffer, void *dest,
                                      int32_t *num_vals, pmix_data_type_t type);
static pmix_status_t
pmix31_bfrops_base_unpack_int(pmix_pointer_array_t *regtypes,
                              pmix_buffer_t *buffer, void *dest,
                              int32_t *num_vals, pmix_data_type_t type);
static pmix_status_t
pmix31_bfrops_base_unpack_sizet(pmix_pointer_array_t *regtypes,
                                pmix_buffer_t *buffer, void *dest,
                                int32_t *num_vals, pmix_data_type_t type);

pmix_bfrops_module_t pmix_bfrops_pmix32_module = {
    .version = "v32",
    .init = init,
    .finalize = finalize,
    .pack = pmix32_pack,
    .unpack = pmix32_unpack,
    .copy = pmix32_copy,
    .print = pmix32_print,
...
static pmix_status_t pmix32_bfrop_pack_array(pmix_pointer_array_t *regtypes,
                                             pmix_buffer_t *buffer, const void *src,
                                             int32_t num_vals, pmix_data_type_t type);
static pmix_status_t pmix32_bfrop_pack_modex(pmix_pointer_array_t *regtypes,
                                             pmix_buffer_t *buffer, const void *src,
                                             int32_t num_vals, pmix_data_type_t type);
static pmix_status_t pmix32_bfrop_unpack_array(pmix_pointer_array_t *regtypes,
                                               pmix_buffer_t *buffer, void *dest,
                                               int32_t *num_vals, pmix_data_type_t type);
static pmix_status_t pmix32_bfrop_unpack_modex(pmix_pointer_array_t *regtypes,
                                               pmix_buffer_t *buffer, void *dest,
                                               int32_t *num_vals, pmix_data_type_t type);
static pmix_status_t pmix32_bfrop_copy_array(pmix_info_array_t **dest,
                                             pmix_info_array_t *src,
                                             pmix_data_type_t type);
static pmix_status_t pmix32_bfrop_copy_modex(pmix_modex_data_t **dest, pmix_modex_data_t *src,
                                             pmix_data_type_t type);
static pmix_status_t pmix32_bfrop_print_array(char **output, char *prefix,
                                              pmix_info_array_t *src, pmix_data_type_t type);
static pmix_status_t pmix32_bfrop_print_modex(char **output, char *prefix,
...
static pmix_status_t init(void)
{
    ...
    PMIX_REGISTER_TYPE("PMIX_BOOL", PMIX_BOOL,
                       ...
                       &mca_bfrops_v32_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_SIZE", PMIX_SIZE,
                       pmix31_bfrops_base_pack_sizet,
                       pmix31_bfrops_base_unpack_sizet,
                       pmix_bfrops_base_std_copy,
    ...
    PMIX_REGISTER_TYPE("PMIX_INT", PMIX_INT,
                       pmix31_bfrops_base_pack_int,
                       pmix31_bfrops_base_unpack_int,
                       pmix_bfrops_base_std_copy,
    ...
    PMIX_REGISTER_TYPE("PMIX_INT16", PMIX_INT16,
                       pmix31_bfrops_base_pack_general_int,
                       pmix31_bfrops_base_unpack_general_int,
                       pmix_bfrops_base_std_copy,
    ...
    PMIX_REGISTER_TYPE("PMIX_MODEX", PMIX_MODEX,
                       pmix32_bfrop_pack_modex,
                       pmix32_bfrop_unpack_modex,
                       pmix32_bfrop_copy_modex,
                       pmix32_bfrop_print_modex,
                       &mca_bfrops_v32_component.types);
    ...
    PMIX_REGISTER_TYPE("PMIX_INFO_ARRAY", PMIX_INFO_ARRAY,
                       pmix32_bfrop_pack_array,
                       pmix32_bfrop_unpack_array,
                       pmix32_bfrop_copy_array,
                       pmix32_bfrop_print_array,
                       &mca_bfrops_v32_component.types);
    /********************/
                                 ...
                                 pmix_data_type_t type)
{
    ...
    return pmix_bfrops_base_pack(&mca_bfrops_v32_component.types,
...
{
     /* kick the process off by passing this in to the base */
    return pmix_bfrops_base_unpack(&mca_bfrops_v32_component.types,
...
static pmix_status_t pmix32_copy(void **dest, void *src,
                                 pmix_data_type_t type)
{
    return pmix_bfrops_base_copy(&mca_bfrops_v32_component.types,
                                 dest, src, type);
}
...
static pmix_status_t pmix32_print(char **output, char *prefix,
                                  void *src, pmix_data_type_t type)
{
    return pmix_bfrops_base_print(&mca_bfrops_v32_component.types,
...
static const char* data_type_string(pmix_data_type_t type)
{
    return pmix_bfrops_base_data_type_string(&mca_bfrops_v32_component.types, type);
}
                                               ...
                                               int32_t *num_vals, pmix_data_type_t type)
{
    ...
    pmix_output_verbose(20, pmix_bfrops_base_framework.framework_output,
                        "pmix32_bfrop_unpack: %d info arrays", *num_vals);
    ...
    for (i = 0; i < n; ++i) {
        pmix_output_verbose(20, pmix_bfrops_base_framework.framework_output,
                            "pmix32_bfrop_unpack: init array[%d]", i);
        ...
        if (0 < ptr[i].size) {
            ...
            m=ptr[i].size;
            if (PMIX_SUCCESS != (ret = pmix_bfrops_base_unpack_value(regtypes, buffer, ptr[i].array, &m, PMIX_INFO))) {
                return ret;
            }
        }
    }
                                               ...
                                               int32_t *num_vals, pmix_data_type_t type)
{
    ...
    pmix_output_verbose(20, pmix_bfrops_base_framework.framework_output,
                        "pmix32_bfrop_unpack: %d modex", *num_vals);
