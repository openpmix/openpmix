...
extern pmix_bfrops_module_t pmix_bfrops_pmix32_module;
 ...
 */
pmix_bfrops_base_component_t mca_bfrops_v32_component = {
    .base = {
        PMIX_BFROPS_BASE_VERSION_1_0_0,

        /* Component name and version */
        .pmix_mca_component_name = "v32",
...
pmix_status_t component_open(void)
{
    ...
    PMIX_CONSTRUCT(&mca_bfrops_v32_component.types, pmix_pointer_array_t);
    pmix_pointer_array_init(&mca_bfrops_v32_component.types, 32, INT_MAX, 16);
...
pmix_status_t component_query(pmix_mca_base_module_t **module, int *priority)
{
    ...
    *priority = mca_bfrops_v32_component.priority;
    *module = (pmix_mca_base_module_t *)&pmix_bfrops_pmix32_module;
    return PMIX_SUCCESS;
}
...
{
    PMIX_DESTRUCT(&mca_bfrops_v32_component.types);
    return PMIX_SUCCESS;
}
...
static pmix_bfrops_module_t* assign_module(void)
{
    pmix_output_verbose(10, pmix_bfrops_base_framework.framework_output,
                        "bfrops:pmix32x assigning module");
    return &pmix_bfrops_pmix32_module;
}
