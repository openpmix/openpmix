...
static pmix_status_t pmix21_pack(pmix_buffer_t *buffer, const void *src, int num_vals,
...
static pmix_status_t pmix21_bfrop_pack_array(pmix_pointer_array_t *regtypes, pmix_buffer_t *buffer,
                                             const void *src, int32_t num_vals,
                                             pmix_data_type_t type);
static pmix_status_t pmix21_bfrop_pack_modex(pmix_pointer_array_t *regtypes, pmix_buffer_t *buffer,
                                             const void *src, int32_t num_vals,
                                             pmix_data_type_t type);
...
static pmix_status_t pmix21_bfrop_unpack_modex(pmix_pointer_array_t *regtypes,
                                               pmix_buffer_t *buffer, void *dest, int32_t *num_vals,
                                               pmix_data_type_t type);
static pmix_status_t pmix21_bfrop_copy_array(pmix_info_array_t **dest, pmix_info_array_t *src,
                                             pmix_data_type_t type);
static pmix_status_t pmix21_bfrop_copy_modex(pmix_modex_data_t **dest, pmix_modex_data_t *src,
                                             pmix_data_type_t type);
static pmix_status_t pmix21_bfrop_print_array(char **output, char *prefix, pmix_info_array_t *src,
                                              pmix_data_type_t type);
...
static pmix_status_t init(void)
{
    ...
    PMIX_REGISTER_TYPE("PMIX_INT16", PMIX_INT16, pack_int16,
