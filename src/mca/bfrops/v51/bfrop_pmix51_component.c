 ...
 */
pmix_bfrops_base_component_t pmix_mca_bfrops_v51_component = {
    .base = {
        PMIX_BFROPS_BASE_VERSION_1_0_0,

        /* Component name and version */
        .pmix_mca_component_name = "v51",
...
PMIX_MCA_BASE_COMPONENT_INIT(pmix, bfrops, v51)

pmix_status_t component_open(void)
{
    /* setup the types array */
    PMIX_CONSTRUCT(&pmix_mca_bfrops_v51_component.types, pmix_pointer_array_t);
    pmix_pointer_array_init(&pmix_mca_bfrops_v51_component.types, 50, INT_MAX, 16);
...
pmix_status_t component_query(pmix_mca_base_module_t **module, int *priority)
{
    ...
    *priority = pmix_mca_bfrops_v51_component.priority;
    *module = (pmix_mca_base_module_t *) &pmix_bfrops_pmix51_module;
    return PMIX_SUCCESS;
}

pmix_status_t component_close(void)
{
    PMIX_DESTRUCT(&pmix_mca_bfrops_v51_component.types);
    return PMIX_SUCCESS;
}
...
static pmix_bfrops_module_t *assign_module(void)
{
    pmix_output_verbose(10, pmix_bfrops_base_framework.framework_output,
                        "bfrops:pmix51 assigning module");
    return &pmix_bfrops_pmix51_module;
}
