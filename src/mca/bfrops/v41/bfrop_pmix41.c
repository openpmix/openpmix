...
static pmix_status_t pmix41_pack(pmix_buffer_t *buffer,
                                const void *src, int num_vals,
                                pmix_data_type_t type);
static pmix_status_t pmix41_unpack(pmix_buffer_t *buffer, void *dest,
                                  int32_t *num_vals, pmix_data_type_t type);
static pmix_status_t pmix41_copy(void **dest, void *src,
                                pmix_data_type_t type);
static pmix_status_t pmix41_print(char **output, char *prefix,
...
pmix41_bfrops_base_pack_general_int(pmix_pointer_array_t *regtypes,
                                   pmix_buffer_t *buffer, const void *src,
                                   int32_t num_vals, pmix_data_type_t type);
static pmix_status_t
pmix41_bfrops_base_pack_int(pmix_pointer_array_t *regtypes,
                           pmix_buffer_t *buffer, const void *src,
                           int32_t num_vals, pmix_data_type_t type);
static pmix_status_t
pmix41_bfrops_base_pack_sizet(pmix_pointer_array_t *regtypes,
                             pmix_buffer_t *buffer, const void *src,
                             int32_t num_vals, pmix_data_type_t type);
static pmix_status_t
pmix41_bfrops_base_unpack_general_int(pmix_pointer_array_t *regtypes,
                                     pmix_buffer_t *buffer, void *dest,
                                     int32_t *num_vals, pmix_data_type_t type);
static pmix_status_t
pmix41_bfrops_base_unpack_int(pmix_pointer_array_t *regtypes,
                             pmix_buffer_t *buffer, void *dest,
                             int32_t *num_vals, pmix_data_type_t type);
static pmix_status_t
pmix41_bfrops_base_unpack_sizet(pmix_pointer_array_t *regtypes,
                               pmix_buffer_t *buffer, void *dest,
                               int32_t *num_vals, pmix_data_type_t type);
...
static pmix_status_t init(void)
{
    ...
    PMIX_REGISTER_TYPE("PMIX_SIZE", PMIX_SIZE,
                       pmix41_bfrops_base_pack_sizet,
                       pmix41_bfrops_base_unpack_sizet,
                       pmix_bfrops_base_std_copy,
    ...
    PMIX_REGISTER_TYPE("PMIX_INT", PMIX_INT,
                       pmix41_bfrops_base_pack_int,
                       pmix41_bfrops_base_unpack_int,
                       pmix_bfrops_base_std_copy,
    ...
    PMIX_REGISTER_TYPE("PMIX_INT16", PMIX_INT16,
                       pmix41_bfrops_base_pack_general_int,
                       pmix41_bfrops_base_unpack_general_int,
                       pmix_bfrops_base_std_copy,
    ...
    PMIX_REGISTER_TYPE("PMIX_JOB_STATE",
                       PMIX_JOB_STATE,
                       pmix_bfrops_base_pack_jobstate,
                       pmix_bfrops_base_unpack_jobstate,
                       pmix_bfrops_base_std_copy,
    ...
    PMIX_REGISTER_TYPE("PMIX_PROC_STATS",
                       PMIX_PROC_STATS,
                       pmix_bfrops_base_pack_pstats,
                       pmix_bfrops_base_unpack_pstats,
                       pmix_bfrops_base_copy_pstats,
                       pmix_bfrops_base_print_pstats,
                       &mca_bfrops_v41_component.types);

    PMIX_REGISTER_TYPE("PMIX_DISK_STATS",
                       PMIX_DISK_STATS,
                       pmix_bfrops_base_pack_dkstats,
                       pmix_bfrops_base_unpack_dkstats,
                       pmix_bfrops_base_copy_dkstats,
                       pmix_bfrops_base_print_dkstats,
                       &mca_bfrops_v41_component.types);

    PMIX_REGISTER_TYPE("PMIX_NET_STATS",
                       PMIX_NET_STATS,
                       pmix_bfrops_base_pack_netstats,
                       pmix_bfrops_base_unpack_netstats,
                       pmix_bfrops_base_copy_netstats,
                       pmix_bfrops_base_print_netstats,
                       &mca_bfrops_v41_component.types);

    PMIX_REGISTER_TYPE("PMIX_NODE_STATS",
                       PMIX_NODE_STATS,
                       pmix_bfrops_base_pack_ndstats,
                       pmix_bfrops_base_unpack_ndstats,
                       pmix_bfrops_base_copy_ndstats,
                       pmix_bfrops_base_print_ndstats,
                       &mca_bfrops_v41_component.types);
...
static void finalize(void)
{
    ...
    for (n=0; n < mca_bfrops_v41_component.types.size; n++) {
        if (NULL != (info = (pmix_bfrop_type_info_t*)pmix_pointer_array_get_item(&mca_bfrops_v41_component.types, n))) {
            PMIX_RELEASE(info);
                                ...
                                pmix_data_type_t type)
{
    ...
    return pmix_bfrops_base_pack(&mca_bfrops_v41_component.types,
...
{
     /* kick the process off by passing this in to the base */
    return pmix_bfrops_base_unpack(&mca_bfrops_v41_component.types,
...
static pmix_status_t pmix41_copy(void **dest, void *src,
                                pmix_data_type_t type)
{
    return pmix_bfrops_base_copy(&mca_bfrops_v41_component.types,
                                 dest, src, type);
}
...
static pmix_status_t pmix41_print(char **output, char *prefix,
                                 void *src, pmix_data_type_t type)
{
    return pmix_bfrops_base_print(&mca_bfrops_v41_component.types,
