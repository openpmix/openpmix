...
static pmix_attr_init_t client_fns[] = {
    ...
    {.function = "PMIx_Fence_nb",
     .attrs = (char *[]){"PMIX_COLLECT_DATA",
                         ...
                         NULL}},
    {.function = "PMIx_Get",
     .attrs = (char *[]){"PMIX_TIMEOUT",
                         "PMIX_OPTIONAL",
                         "PMIX_IMMEDIATE",
                         "PMIX_GET_REFRESH_CACHE",
                         "PMIX_DATA_SCOPE",
                         "PMIX_GET_POINTER_VALUES",
    ...
    {.function = "PMIx_Get_nb",
     .attrs = (char *[]){"PMIX_TIMEOUT",
                         ...
                         "PMIX_APPNUM",
                         NULL}},
    {.function = "PMIx_Publish",
     .attrs = (char *[]){"PMIX_RANGE",
                         "PMIX_PERSISTENCE",
    ...
    {.function = "PMIx_Publish_nb",
     .attrs = (char *[]){"PMIX_RANGE",
                         ...
                         "PMIX_TIMEOUT",
                         NULL}},
    {.function = "PMIx_Lookup",
     .attrs = (char *[]){"PMIX_RANGE",
                         "PMIX_WAIT",
                         "PMIX_TIMEOUT",
                         NULL}},
    {.function = "PMIx_Lookup_nb",
     .attrs = (char *[]){"PMIX_RANGE",
                         "PMIX_WAIT",
                         "PMIX_TIMEOUT",
                         NULL}},
    {.function = "PMIx_Unpublish",
     .attrs = (char *[]){"PMIX_RANGE",
                         "PMIX_TIMEOUT",
                         NULL}},
    {.function = "PMIx_Unpublish_nb",
     .attrs = (char *[]){"PMIX_RANGE",
                         "PMIX_TIMEOUT",
                         NULL}},
    {.function = "PMIx_Spawn",
     .attrs = (char *[]){"PMIX_WDIR",
                         ...
                         "PMIX_NOTIFY_PROC_TERMINATION",
                         "PMIX_NOTIFY_PROC_ABNORMAL_TERMINATION",
                         "PMIX_NOTIFY_JOB_EVENTS",
    ...
    {.function = "PMIx_Connect",
     .attrs = (char *[]){"PMIX_ALL_CLONES_PARTICIPATE",
                         "PMIX_TIMEOUT",
                         NULL}},
    {.function = "PMIx_Connect_nb",
     .attrs = (char *[]){"PMIX_ALL_CLONES_PARTICIPATE",
                         "PMIX_TIMEOUT",
                         NULL}},
    {.function = "PMIx_Disconnect",
     .attrs = (char *[]){"PMIX_ALL_CLONES_PARTICIPATE",
                         "PMIX_TIMEOUT",
                         NULL}},
    {.function = "PMIx_Disconnect_nb",
     .attrs = (char *[]){"PMIX_ALL_CLONES_PARTICIPATE",
                         "PMIX_TIMEOUT",
                         NULL}},
    ...
    {.function = "PMIx_Query_info",
     .attrs = (char *[]){"PMIX_QUERY_NAMESPACES",
                         ...
                         "PMIX_SERVER_INFO_ARRAY",
                         "PMIX_SERVER_START_TIME",
                         ...
                         "PMIX_ALLOC_PROPERTY",
                         "PMIX_QUERY_MIN_ALLOC_UNIT",
                         "PMIX_QUERY_RES_BLOCKS",
                         "PMIX_QUERY_RES_BLOCK_DEF",
                         ...
                         "PMIX_GROUP_ID",
                         "PMIX_QUERY_PROC_RESOURCE_USAGE",
                         "PMIX_NODEID",
                         "PMIX_HOSTNAME",
                         ...
                         "PMIX_APP_INFO",
                         "PMIX_NODE_INFO",
                         "PMIX_CLIENT_ATTRIBUTES",
                         "PMIX_SERVER_ATTRIBUTES",
                         "PMIX_HOST_ATTRIBUTES",
                         "PMIX_TOOL_ATTRIBUTES",
                         "PMIX_CLIENT_FUNCTIONS",
                         "PMIX_SERVER_FUNCTIONS",
                         "PMIX_TOOL_FUNCTIONS",
                         "PMIX_HOST_FUNCTIONS",
                         "PMIX_QUERY_LOCAL_ONLY",
                         "PMIX_QUERY_REPORT_AVG",
                         "PMIX_QUERY_REPORT_MINMAX",
    ...
    {.function = "PMIx_Query_info_nb",
     .attrs = (char *[]){"PMIX_QUERY_NAMESPACES",
                         ...
                         NULL}},
    {.function = "PMIx_Log",
     .attrs = (char *[]){"PMIX_LOG_GENERATE_TIMESTAMP",
                         "PMIX_LOG_SOURCE",
                         NULL}},
    ...
    {.function = "PMIx_Job_control_nb",
     .attrs = (char *[]){"PMIX_JOB_CTRL_ID",
                         ...
                         "PMIX_REQUESTOR",
                         NULL}},
    {.function = "PMIx_Process_monitor",
     .attrs = (char *[]){"PMIX_MONITOR_HEARTBEAT",
                         "PMIX_SEND_HEARTBEAT",
                         "PMIX_MONITOR_FILE",
                         ...
                         "PMIX_MONITOR_TARGET_NODES",
                         "PMIX_MONITOR_TARGET_NODEIDS",
                         "PMIX_MONITOR_TARGET_DISKS",
                         "PMIX_MONITOR_TARGET_NETS",
                         ...
                         "PMIX_GRPID",
                         NULL}},
    {.function = "PMIx_Process_monitor_nb",
     .attrs = (char *[]){"PMIX_MONITOR_HEARTBEAT",
                         "PMIX_SEND_HEARTBEAT",
                         "PMIX_MONITOR_FILE",
                         "PMIX_MONITOR_PROC_RESOURCE_USAGE",
                         ...
                         "PMIX_GRPID",
                         NULL}},
    {.function = "PMIx_Get_credential",
     .attrs = (char *[]){"PMIX_CRED_TYPE",
                         "PMIX_TIMEOUT",
                         "PMIX_USERID",
                         "PMIX_GRPID",
                         NULL}},
    {.function = "PMIx_Get_credential_nb",
     .attrs = (char *[]){"PMIX_CRED_TYPE",
                         "PMIX_TIMEOUT",
                         "PMIX_USERID",
                         "PMIX_GRPID",
                         NULL}},
    {.function = "PMIx_Validate_credential",
     .attrs = (char *[]){"PMIX_USERID",
                         "PMIX_GRPID",
                         "PMIX_TIMEOUT",
                         "PMIX_CRED_TYPE",
                         NULL}},
    {.function = "PMIx_Validate_credential_nb",
     .attrs = (char *[]){"PMIX_USERID",
                         "PMIX_GRPID",
                         "PMIX_TIMEOUT",
                         "PMIX_CRED_TYPE",
    ...
    {.function = "PMIx_Group_construct_nb",
     .attrs = (char *[]){"PMIX_GROUP_ID",
                         ...
                         "PMIX_GROUP_MEMBERSHIP",
                         NULL}},
    {.function = "PMIx_Group_invite",
     .attrs = (char *[]){"PMIX_GROUP_OPTIONAL",
                         "PMIX_GROUP_ASSIGN_CONTEXT_ID",
                         "PMIX_TIMEOUT",
                         NULL}},
    {.function = "PMIx_Group_invite_nb",
     .attrs = (char *[]){"PMIX_GROUP_OPTIONAL",
                         "PMIX_GROUP_ASSIGN_CONTEXT_ID",
                         "PMIX_TIMEOUT",
                         NULL}},
    ...
    {.function = "PMIx_Group_destruct",
     .attrs = (char *[]){"PMIX_GROUP_NOTIFY_TERMINATION",
                         "PMIX_TIMEOUT",
                         NULL}},
    {.function = "PMIx_Group_destruct_nb",
     .attrs = (char *[]){"PMIX_GROUP_NOTIFY_TERMINATION",
                         "PMIX_TIMEOUT",
                         NULL}},
    {.function = "PMIx_Register_event_handler",
     .attrs = (char *[]){"PMIX_EVENT_HDLR_NAME",
    ...
    {.function = "PMIx_Notify_event",
     .attrs = (char *[]){"PMIX_EVENT_NON_DEFAULT",
                         ...
                         "PMIX_EVENT_TIMESTAMP",
                         "PMIX_EVENT_STAYS_LOCAL",
                         "PMIX_EVENT_SILENT_TERMINATION",
                         "PMIX_EVENT_AFFECTED_PROC",
                         "PMIX_EVENT_AFFECTED_PROCS",
                         "PMIX_EVENT_TERMINATE_SESSION",
                         "PMIX_EVENT_TERMINATE_JOB",
                         "PMIX_EVENT_TERMINATE_NODE",
                         "PMIX_EVENT_TERMINATE_PROC",
                         "PMIX_EVENT_ACTION_TIMEOUT",
                         NULL}},
...
static pmix_attr_init_t server_fns[] = {
    {.function = "PMIx_server_init",
     .attrs = (char *[]){"PMIX_SERVER_NSPACE",
                         ...
                         "PMIX_ALLOW_CLIENT_CLONES",
                         "PMIX_TOPOLOGY2",
                         "PMIX_SERVER_SHARE_TOPOLOGY",
                         "PMIX_HOMOGENEOUS_SYSTEM",
    ...
    {.function = "PMIx_server_register_nspace",
     .attrs = (char *[]){"PMIX_REGISTER_NODATA",
                         "PMIX_SESSION_INFO_ARRAY",
                         "PMIX_JOB_INFO_ARRAY",
                         "PMIX_APP_INFO_ARRAY",
    ...
    {.function = "PMIx_server_setup_application",
     .attrs = (char *[]){"PMIX_SETUP_APP_ENVARS",
                         ...
                         "PMIX_ALLOC_FABRIC_ENDPTS_NODE",
                         "PMIX_PROC_MAP",
                         "PMIX_NODE_MAP",
                         "PMIX_ALLOC_BANDWIDTH",
                         "PMIX_ALLOC_FABRIC_QOS",
                         "PMIX_SESSION_INFO",
                         "PMIX_PROGRAMMING_MODEL",
                         "PMIX_MODEL_LIBRARY_NAME",
                         "PMIX_MODEL_LIBRARY_VERSION",
    ...
    {.function = "PMIx_server_IOF_deliver",
     .attrs = (char *[]){"PMIX_IOF_COMPLETE",
                         "PMIX_IOF_TAG_OUTPUT",
                         "PMIX_IOF_RANK_OUTPUT",
                         "PMIX_IOF_XML_OUTPUT",
                         "PMIX_IOF_OUTPUT_RAW",
                         NULL}},
    {.function = "PMIx_server_collect_inventory",
     .attrs = (char *[]){"PMIX_HOSTNAME",
                         "PMIX_NODEID",
                         NULL}},
    {.function = "PMIx_server_deliver_inventory",
     .attrs = (char *[]){"PMIX_HOSTNAME",
                         "PMIX_NODEID",
                         NULL}},
...
static pmix_attr_init_t tool_fns[]
    ...
    {.function = "PMIx_tool_init",
     .attrs = (char *[]){"PMIX_TOOL_NSPACE",
                         ...
                         "PMIX_MYSERVER_URI",
                         "PMIX_CONNECTION_ORDER",
                         "PMIX_CONNECT_MAX_RETRIES",
                         "PMIX_CONNECT_RETRY_DELAY",
                         "PMIX_PRIMARY_SERVER",
                         "PMIX_LAUNCHER_RENDEZVOUS_FILE",
                         "PMIX_LAUNCHER_DAEMON",
                         "PMIX_EXEC_AGENT",
                         "PMIX_LAUNCH_DIRECTIVES",
                         "PMIX_FWD_STDIN",
                         "PMIX_NOHUP",
                         "PMIX_IOF_LOCAL_OUTPUT",
                         "PMIX_SERVER_TMPDIR",
    ...
    {.function = "PMIx_tool_connect_to_server",
     .attrs = (char *[]){"PMIX_CONNECT_TO_SYSTEM",
                         ...
                         "PMIX_TOOL_ATTACHMENT_FILE",
                         NULL}},
    {.function = "PMIx_IOF_pull",
     .attrs = (char *[]){"PMIX_IOF_CACHE_SIZE",
