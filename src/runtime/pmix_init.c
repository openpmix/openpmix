...
PMIX_EXPORT pmix_globals_t pmix_globals = {
    ...
    .evauxbase = NULL,
    .debug_output = -1,
    .events = PMIX_EVENTS_STATIC_INIT(pmix_globals.events),
    .event_window = {0, 0},
    .cached_events = PMIX_LIST_STATIC_INIT(pmix_globals.cached_events),
    .iof_requests = PMIX_POINTER_ARRAY_STATIC_INIT,
    .max_events = INT_MAX,
    .event_eviction_time = 0,
    .notifications = PMIX_HOTEL_STATIC_INIT,
    .pushstdin = false,
    .stdin_targets = PMIX_LIST_STATIC_INIT(pmix_globals.stdin_targets),
    .tag_output = false,
    .xml_output = false,
    .timestamp_output = false,
    .output_limit = SIZE_MAX,
    .nspaces = PMIX_LIST_STATIC_INIT(pmix_globals.nspaces),
    .topology = {NULL, NULL},
    .cpuset = {NULL, NULL},
    ...
    .spawns_in_flight = 0,
    .iof_pending = PMIX_LIST_STATIC_INIT(pmix_globals.iof_pending),
    .iof_pending_bytes = 0,
    .iof_pending_limit = 0,
